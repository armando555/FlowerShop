                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('bouquet.update') }}">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="id" value="{{ $data['bouquet']->getId() }}"
                                enctype="multipart/form-data">
                            <label for="exampleInputName">{{ __('messages.name') }}</label>
                            <input type="text" class="form-control" name="name" aria-describedby="nameHelp"
                                placeholder="{{ __('messages.enterName') }}" value="{{ $data['bouquet']->getName() }}">
                            ...
                            <input type="text" class="form-control" name="bouquetType" aria-describedby="nameHelp"
                                ...
                                value="{{ $data['bouquet']->getBouquetType() }}">

                            <label for="exampleInputName">{{ __('messages.rate') }}</label>
                            <input type="text" class="form-control" name="rate" aria-describedby="nameHelp"
                                placeholder="{{ __('messages.rate') }}" value="{{ $data['bouquet']->getRate() }}">

                            <div class="mb-3 mt-2">
                                <label for="formFile" class="form-label">{{ __('messages.image') }}</label>
                                <input class="form-control" type="file" id="formFile"
                                    value="{{ $data['bouquet']->getUrlImg() }}" name="urlImg">
                            </div>
                            ...
                            <input type="numeric" class="form-control" name="price" aria-describedby="numHelp"
                                placeholder="{{ __('messages.enterPrice') }}"
                                value="{{ $data['bouquet']->getPrice() }}">
