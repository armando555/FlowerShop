...
@section('content')
    ...
    <div class="center">
        <div class="bread-crumbs-container">
            {{ Breadcrumbs::render('editFlower', $data['flower']) }}
        </div>
    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="card margin-top margin-bottom">
                <div class="card-header">
                    <h3>{{ __('messages.completeFields') }}{{ ' ' }}{{ __('messages.updateFlower') }}</h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('flower.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" aria-describedby="nameHelp"
                                placeholder="Enter name" value="{{ $data['flower']->getName() }}">
                            ...
                            <input type="text" class="form-control" name="spice" aria-describedby="nameHelp"
                                placeholder="Enter spice" value="{{ $data['flower']->getSpice() }}">
                            ...
                            <input type="numeric" class="form-control" name="amountPerFlower" aria-describedby="numHelp"
                                placeholder="Enter amount per flower"
                                value="{{ $data['flower']->getAmountPerFlower() }}">
                            ...
                            <input type="text" class="form-control" name="color" aria-describedby="nameHelp"
                                placeholder="Enter color" value="{{ $data['flower']->getColor() }}">
                            ...
                            <input type="text" class="form-control" name="description" aria-describedby="nameHelp"
                                placeholder="Enter description" value="{{ $data['flower']->getDescription() }}">
                            ...
                            <input type="numeric" class="form-control" name="price" aria-describedby="numHelp"
                                placeholder="Enter price" value="{{ $data['flower']->getPrice() }}">

                            <div class="mb-3 mt-2">
                                <label for="formFile" class="form-label">{{ __('messages.image') }}</label>
                                <input class="form-control" type="file" id="formFile"
                                    value="{{ $data['flower']->getUrlImg() }}" name="urlImg">
                            </div>
