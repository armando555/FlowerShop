            ...
            <div class="card-body">
                ...
                <ul>
                    @if(count($flowers)!=0)
                        ...
                        <a class="btn btn-danger" href="{{route('flower.delete',$flower->getId())}}">{{__('messages.delete')}}</a>
                        @endforeach
                    @endif
                </ul>
                ...
                <ul>
                    @if(count($bouquets)!=0)
                        ...
                        <a class="btn btn-danger" href="{{route('bouquet.delete',$bouquet->getId())}}">{{__('messages.delete')}}</a>
                        @endforeach
                    @endif
                </ul>
                ...
                <ul>
                    @if (count($combos)!=0)
                        ...
                        <a class="btn btn-danger" href="{{route('combo.delete',$combo->getId())}}">{{__('messages.delete')}}</a>
                        @endforeach    
                    @endif
                ...
                <ul>
                    @if (count($candies)!=0)
                        ...
                        <a class="btn btn-danger" href="{{route('candy.delete',$candy->getId())}}">{{__('messages.delete')}}</a>
                        @endforeach
                    @endif
